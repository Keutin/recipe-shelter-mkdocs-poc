...
- [`_draft_adr/`](../../soutenance/backend/adr/) — architecture decision records (jury defense)
- [`_draft_uml/`](../../soutenance/backend/uml/) — UML diagrams
- [`_draft_deployment/`](../../deployment/) — deployment plan (Railway)
